 ...
 *
 *  与同目录 EditContextMenu.h 的关系：那一份服务的是寄宿真子窗口的纯文本
 *  输入控件 DuiEditHost，只有剪切、复制、粘贴、全选四条命令。本文件另起一份
 *  而不是往那边加命令，是因为往那边的枚举里塞撤销、重做、删除、粘贴为纯文本，
 *  会连带改变该控件的菜单，属于计划外的行为变化。代价是两份文件里都有剪切 /
 *  复制 / 粘贴 / 全选的规则。
 *
